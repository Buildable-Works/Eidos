...
Set who you are below — `eidos-init` asks, or just edit this file. Leaving it blank is fine: the agent
defaults to full, product-owner-style facilitation and offers to record who you are.

## You are:

<!-- Name your role and how you want to be helped. The base roles Eidos recognizes:
     - Product Owner — holds intent, scope, decisions; full authoring, press on scope.
